...
export const ScamPreventionBox: React.FC<BoxProps> = ({
  ...
  return (
    <motion.div
      ...
      } duration-300 bg-white border rounded-lg w-full p-5 shadow-md grid grid-rows-[2rem_1fr_3rem] hover:bg-gray-50`}
    >
      <h2 className="font-bold h-fit">{title}</h2>
      <motion.div className="my-2 h-full self-start flex items-start">
        <motion.p className="content-start h-fit flex flex-wrap mb-auto">
          {onEnter
